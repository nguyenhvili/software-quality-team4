...
namespace StocksReportingLibrary.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20250511211048_ChangeEmailSendStatusType")]
    partial class ChangeEmailSendStatusType
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StocksReportingLibrary.Domain.EmailMessage.EmailMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT")
            ...
            modelBuilder.Entity("StocksReportingLibrary.Domain.EmailMessage.EmailMessage", b =>
                {
                    b.OwnsMany("StocksReportingLibrary.Domain.EmailAttachmentPath.EmailAttachmentPath", "EmailAttachments", b1 =>
                        {
                            b1.Property<Guid>("Id")
                                .HasColumnType("TEXT")
                    ...
                    b.OwnsOne("StocksReportingLibrary.Domain.EmailMessage.ValueObjects.EmailBody", "EmailBody", b1 =>
                        {
                            b1.Property<Guid>("EmailMessageId")
                                .HasColumnType("TEXT");
                    ...
                    b.OwnsOne("StocksReportingLibrary.Domain.EmailMessage.ValueObjects.EmailRecipient", "EmailRecipient", b1 =>
                        {
                            b1.Property<Guid>("EmailMessageId")
                                .HasColumnType("TEXT");
                    ...
                    b.OwnsOne("StocksReportingLibrary.Domain.EmailMessage.ValueObjects.EmailSubject", "EmailSubject", b1 =>
                        {
                            b1.Property<Guid>("EmailMessageId")
                                .HasColumnType("TEXT");
                    ...
                    b.OwnsOne("StocksReportingLibrary.Domain.EmailMessage.ValueObjects.RetryCount", "RetryCount", b1 =>
                        {
                            b1.Property<Guid>("EmailMessageId")
                                .HasColumnType("TEXT");
